  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        ...
        >
          <Icon name="camera" size={80} color="#e1e5cf" style={styles.icon} />

          <Text style={styles.title}>Intruder Alert</Text>

          <Text style={styles.description}>
            The app will take a photo when the password is entered incorrectly so you can view
            who tried to open your vault. If the password is entered incorrectly more than 3 times, 
            an alarm will sound, and the app will capture a selfie of the intruder. 
          </Text>
        </Animated.View>
